    ...
    public class InvController : Controller
    {
        ...
        public string SelectInvoiceHeader([FromForm] InvoiceIn inputParams)
        {
            ...
            try
            {
                ...
                string[] arr = { RouteCondition.ToString(), AreaCondition.ToString(), SubAreaCondition.ToString(), CustomerOutletCondition.ToString(), 
                    CustomerCondition.ToString(), PaymentTypeCondition.ToString(), InvoiceTypeCondition.ToString(), InvoiceWithCondition.ToString() };                

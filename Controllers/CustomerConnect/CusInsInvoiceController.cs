    ...
    public class CusInsInvoiceController : Controller
    {
        ...
        public string SelectCusInvoiceHeader([FromForm] CusInvoiceIn inputParams)
        {
            ...
            try
            {
                ...
                string[] arr = { dateCondition.ToString(), RouteCondition.ToString(), AreaCondition.ToString(), SubAreaCondition.ToString(), PaymentTypeCondition.ToString(), 
                    InvoiceTypeCondition.ToString(), InvoiceWithCondition.ToString() };
